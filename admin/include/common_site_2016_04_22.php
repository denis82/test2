  ...
  function get_short_desc($id1, $id2 = "", $params=array()){
    ...
    foreach ($ids as $key => $id) {
      if($id){
          ...
          $anons = get_value_har($element["id"], "anons");
      	}
        if(!$anons){
        ...
        $img = "";
      	...
      	$small_pic = get_value_har($element["id"], "icon");
    		if($small_pic){
    		  ...
    		  $img = "<div style=\"width:$small_pic_info[width]px; height:$small_pic_info[height]px;\" class=\"cat-pic\"><a href=\"$url\"><img src=\"$small_pic_info[link]\" width=\"$small_pic_info[width]\" height=\"$small_pic_info[height]\"  alt='$element[name]' title='$element[name]'></a><i class=\"tl\"></i><i class=\"tr\"></i><i class=\"bl\"></i><i class=\"br\"></i></div>";
    		}
...
$menu .= "<li><a href=\"/corp\">Корпоративные подарки</a></li>";
                ...
                $parameter_page["main_text"] .= "
                            <li class=\"catalog-item\">
                                <div class=\"catalog-item-content\">
                                    ...
                                    <p>" . $product["name"] . "</p>
                                    <div class=\"cat-pic\" style=\"width:99px; height:98px;\"><a href=\"/catalog/" . $product["id"] . "\"><img width=\"99\" height=\"98\" title=\"" . $product["name"] . "\" alt=\"" . $product["name"] . "\" src=\"$photo_info[link]\"></a><i class=\"tl\"></i><i class=\"tr\"></i><i class=\"bl\"></i><i class=\"br\"></i></div>
                                    <div class=\"price\"><div>" . $product["price"] . ".<span class=\"rur\"><cufon class=\"cufon cufon-canvas\" alt=\"p\" style=\"width: 12px; height: 14.1667px;\"><canvas width=\"14\" height=\"10\" style=\"width: 14px; height: 10px; top: 1px; left: -1px;\"></canvas><cufontext>p</cufontext></cufon><span></span></span></div></div>
                                </div>
                            </li>";
                $i++;
                if ($i == 4) break;
